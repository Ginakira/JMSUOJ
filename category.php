...
if (!$result) {
    ...
    foreach ($category as $cat) {
        ...
        $view_category .= "<a class='badge badge-$label_theme' style='font-size: 15px; display: inline-block;' href='problemset.php?search=" . urlencode(htmlentities($cat, ENT_QUOTES, 'UTF-8')) . "'>" . $cat . "</a>&nbsp;";
    }
