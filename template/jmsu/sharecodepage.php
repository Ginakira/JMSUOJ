...
<div class="container">
    ...
    <div class="jumbotron">
        ...
        <center>
            <?php if ($readOnly) { ?>
                <br>
                <span class="label label-primary">author:</span> <a
                        href="userinfo.php?user=<?php echo $author ?>"><?php echo $author ?></a>
...
<?php echo $MSG_VCODE ?>:
<input id="vcode" size=4 type=text><img id="vimg" alt="click to change" src="vcode.php"
...
<br>
            ...
            <pre id="code" cols=180 rows=20 class="ace_editor" style="min-height:600px;width: 80%"><textarea id="source"
                                                                                                             class="ace_text-input"><?php echo htmlentities($view_src, ENT_QUOTES, "UTF-8") ?></textarea></pre>
            <?php if (!$readOnly) { ?>
