...
?>
<br><br>
<a class='btn btn-info btn-sm' href='status.php?cid=<?php echo $view_cid ?>'><i class='fas fa-hourglass-half'></i> 提交记录</a>
<a class='btn btn-success btn-sm' href='contestrank.php?cid=<?php echo $view_cid ?>'><i class='fas fa-thumbs-up'></i> 排名</a>
<a class='btn btn-secondary btn-sm' href='conteststatistics.php?cid=<?php echo $view_cid ?>'><i class='fas fa-file-alt'></i> 统计</a>
</div>
