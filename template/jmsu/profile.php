...
if (isset($_SESSION[$OJ_NAME . '_' . 'user_id'])) {
    ...
    $profile .= "<li><a class='dropdown-item' href=" . $path_fix .
        "modifypage.php>$MSG_REG_INFO</a></li>&nbsp;<li><a class='dropdown-item' href='" .
        $path_fix . "userinfo.php?user=$sid'><span id=red>$MSG_USERINFO</span></a></li>";
