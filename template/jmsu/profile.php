...
if(isset($_SESSION[$OJ_NAME.'_'.'user_id'])){
  ...
  $profile.= "<li><a class='dropdown-item' href=".$path_fix."modifypage.php>$MSG_REG_INFO</a></li>&nbsp;<li><a class='dropdown-item' href='".$path_fix."userinfo.php?user=$sid'><span id=red>$MSG_USERINFO</span></a></li>";
  ...
  $profile.="&nbsp;<li><a class='dropdown-item' href='".$path_fix."contest.php?my'><span id=red>$MSG_MY_CONTESTS</span></a></li>";
  if(
  ...
  $profile.= "&nbsp;<li><a class='dropdown-item' href=".$path_fix."logout.php>$MSG_LOGOUT</a></li>&nbsp;";
  ...
  $profile.= "<li><a class='dropdown-item' href=".$path_fix."loginpage.php>$MSG_LOGIN</a></li>&nbsp;";

  if($OJ_LOGIN_MOD=="hustoj"){
    if(isset($OJ_REGISTER)&&!$OJ_REGISTER){
    }else{
      $profile.= "<li><a class='dropdown-item' href=".$path_fix."registerpage.php>$MSG_REGISTER</a></li>&nbsp;";
    }
  }
}
...
if(isset($_SESSION[$OJ_NAME.'_'.'administrator'])||isset($_SESSION[$OJ_NAME.'_'.'contest_creator'])||isset($_SESSION[$OJ_NAME.'_'.'problem_editor'])){
  $profile.= "<li><a class='dropdown-item' href=".$path_fix."admin/>$MSG_ADMIN</a></li>&nbsp;";
}
