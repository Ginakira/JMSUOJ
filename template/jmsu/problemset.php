...
<div class="container">
    ...
    <div class="jumbotron">
        <center>
            <nav id="page" class="d-flex justify-content-center">
                <ul class="pagination">
        ...
        <a class='page-link' href='problemset.php?page=" . $i . "'>" . $i . "</a></li>";
                    ...
                    <li class="page-item"><a class="page-link"
                                             href="problemset.php?page=<?php echo $view_total_page ?>">&gt;&gt;</a>
                    </li>
                </ul>
            </nav>
                    ...
                    <td colspan='1'>
                        <form class="form-search form-inline">
                            <input type="text" name=search class="form-control search-query"
                                   placeholder="Keywords Title or Source">
            ...
            <table id='problemset' width='90%' class='table-responsive table-striped table-bordered'>
                <thead>
                <tr class='toprow'>
                    <th width='5'>状态</th>
