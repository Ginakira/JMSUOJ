...
<table id=rank><thead><tr class=toprow align=center><td class="{sorter:'false'}" width=5%>名次<th width=10%>用户ID</th><th width=10%>昵称</th><th width=5%>AC</th><th width=5%>用时</th>
<?php
for ($i=0;$i<$pid_cnt;$i++)
