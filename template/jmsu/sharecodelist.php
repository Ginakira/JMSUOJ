    ...
    <div class="jumbotron">
        ...
        <center>
            <table class="table table-striped">
                <caption style="text-align: center;font-size: 20px">代码分享列表，<a href="./sharecodepage.php">立即分享</a>
                </caption>
                <tr>
                    <th>编号</th>
                    <th>标题</th>
            ...
            <?php if ($pageNum > 1) { ?>
                <nav aria-label="...">
                    <ul class="pagination">
                        <li><a href="./sharecodelist.php?page=1" aria-label="Previous"><span aria-hidden="true">«</span></a>
                        </li>
                        <?php for ($i = 1; $i <= $pageNum; $i++) {
                            echo "<li><a href='./sharecodelist.php?page=" . $i . "'>" . $i . "</a></li>";
                        } ?>
                        <li><a href="./sharecodelist.php?page=<?php echo $pageNum ?>" aria-label="Next"><span
