...
?>
			...
			<div id=center class="text-center">
				<?php echo "<a href='status.php?" . $str2 . "' class='btn btn-info'><<</a>&nbsp;&nbsp;";
if (isset($_GET['prevtop'])) {
    echo "<a href='status.php?" . $str2 . "&top=" . intval($_GET['prevtop']) . "' class='btn btn-info'>上一页</a>&nbsp;&nbsp;";
} else {
    echo "<a href='status.php?" . $str2 . "&top=" . ($top + 20) . "' class='btn btn-info'>上一页</a>&nbsp;&nbsp;";
}

echo "<a href='status.php?" . $str2 . "&top=" . $bottom . "&prevtop=$top' class='btn btn-info'>下一页</a>";
?>
			</div>
