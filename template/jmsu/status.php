...
<div class="container">
    ...
    <div class="jumbotron">
        ...
        <div id=center>
            <table id=result-tab class="table content-box-header" align=center width=80%>
        ...
        <div id=center class="text-center">
            <?php echo "<a href='status.php?" . $str2 . "' class='btn btn-secondary'><<</a>&nbsp;&nbsp;";
            if (isset($_GET['prevtop'])) {
                echo "<a href='status.php?" . $str2 . "&top=" . intval($_GET['prevtop']) . "' class='btn btn-primary'>上一页</a>&nbsp;&nbsp;";
            } else {
                echo "<a href='status.php?" . $str2 . "&top=" . ($top + 20) . "' class='btn btn-primary'>上一页</a>&nbsp;&nbsp;";
            }

            echo "<a href='status.php?" . $str2 . "&top=" . $bottom . "&prevtop=$top' class='btn btn-primary'>下一页</a>";
            ?>
        </div>
