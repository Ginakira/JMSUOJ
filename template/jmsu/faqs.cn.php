...
<main role="main" class="flex-shrink-0">
    <div class="container">
        ...
        <div class="row">
            <div class="col">
                <h1 class="display-4 text-center"><?php echo $OJ_NAME ?> FAQ</h1>
            </div>
        </div>
        <div class="row mb-4">
            <div class="col bg-light">
                <p><font color=green>Q</font>:这个在线评测系统使用什么样的编译器和编译选项?<br>
                    <font color=red>A</font>:系统运行于<a href="http://www.ubuntu.com">Ubuntu 16.04 x64</a>
                ...
                <table class="table table-stripped table-bordered">
                    <tr>
                        <td>C:</td>
                        <td><font color=blue>gcc Main.c -o Main -fno-asm -Wall -lm --static -std=c99
                                -DONLINE_JUDGE</font>
                    ...
                    <tr>
                        <td>C++:</td>
                        <td><font color=blue>g++ -fno-asm -Wall -lm --static -std=c++11 -DONLINE_JUDGE -o Main
                                Main.cc</font>
                        </td>
                    </tr>
                    <tr>
                ...
                <ul>
                    <li><font color=blue>main</font> 函数必须返回<font color=blue>int</font>, <font color=blue>void
                            main</font>
                        的函数声明会报编译错误。<br>
                    <li><font color=green>i</font> 在循环外失去定义 "<font color=blue>for</font>(<font color=blue>int</font>
                        <font
                                color=green>i</font>=0...){...}"<br>
                    <li><font color=green>itoa</font> 不是ansi标准函数.<br>
                    <li><font color=green>__int64</font> 不是ANSI标准定义，只能在VC使用, 但是可以使用<font color=blue>long long</font>声明64位整数。<br>如果用了__int64,可尝试提交前加一句#define
