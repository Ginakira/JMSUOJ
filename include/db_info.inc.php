...
static $DB_PASS = "SIzUyxdAKWmA7Y88"; //数据库密码

static $OJ_NAME = "JMSU OnlineJudge"; //左上角显示的系统名称
static $OJ_HOME = "./"; //主页目录
static $OJ_ADMIN = "root@localhost"; //管理员email
static $OJ_DATA = "/home/judge/data"; //测试数据目录
static $OJ_BBS = "discuss3"; //"bbs" for phpBB3 bridge or "discuss" for mini-forum or false for close any
...
static $OJ_TEMPLATE = "jmsu"; //使用的默认模板, [bs3 ie ace sweet sae] work with discuss3, [classic bs] work with discuss
...
//AutoWA Add
static $OJ_CONTEST_SHOWID = false; //比赛页是否显示所用题的题号
